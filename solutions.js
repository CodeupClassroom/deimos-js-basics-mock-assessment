...
//Define a function named isTrue that takes in
// any input and returns true if the input provided is exactly equal to true in value and data type.
//
...
//Define a function named isFalse that takes in a
// value and returns a true if and only if the provided input is equal to false in both type and value.
...
//Define a function named isEven that takes in a single input. If the input is an even number or a string
// containing an even number, return true. Any other input should return false for the output.
